...
# -> Main label header
header_Label = customtkinter.CTkLabel(master = frame, text = "File State", font = ("Carlito", 24))
...
entry_FileName.pack(pady = 2, padx = 10)

# -> Displays file instructions
FileName_Label = customtkinter.CTkLabel(master = frame, text = "Please enter a file and the extension", font = ("Carlito", 14))
...
AccessMode_Label = customtkinter.CTkLabel(master = frame, text = '(Append = "a", Read = "r", Overwrite = "w")', font = ("Carlito", 14))
AccessMode_Label.pack(pady = 6, padx = 10)

# -> Space for entering in your text
entry_UserText = customtkinter.CTkTextbox(master = frame, height = 100 , width = 400)
entry_UserText.pack(pady = 2, padx = 10)

# -> Button Label Trigger
UserText_Label = customtkinter.CTkLabel(master = frame, text = "Enter your text above if writting", font = ("Carlito", 14))
...
# -> Button Label Trigger
action_Label = customtkinter.CTkLabel(master = frame, text = "", font = ("Carlito", 14))
action_Label.pack(pady = 6, padx = 10)

# -> Label to display text to user
reader_Label = customtkinter.CTkLabel(master = frame, text = "", font = ("Carlito", 24))
